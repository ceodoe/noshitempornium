    ...
    for(var j = 0; j < illegalTags.length; j++) {
        ...
        for(var k = 0; k < tagList.length; k++) {
            if(tagList[k].innerHTML == illegalTags[j]) {
                currentHidden = true;
                tagList[k].setAttribute("style","color: #F00 !important; font-weight: bold !important; display: inline;");
            }

            if(whitelist.includes(tagList[k].innerHTML) === true) {
                currentWhitelisted = true;
                tagList[k].setAttribute("style","color: #0F0 !important; font-weight: bold !important; display: inline;");
            }
        }
    }
